...
function rounded_corners($element)
	{
	var $rc_radius=8, $rc_left=true, $rc_right=true, $rc_top=true, $rc_bottom=true, $rc_self_color, $rc_parent_color, $rc_antialiased,$rc_antialiased_cf=0.33,$rc_compact,$rc_auto_margin,$rc_method="margin",$rc_border=true,$border_color="ffd954";
...
addEvent(window, 'load', make_corners);